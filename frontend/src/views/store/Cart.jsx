                    ...
                    <section className="">
                        ...
                        <div className="col-lg-8 mb-4 mb-md-0">
                            ...
                            {cart?.map((c, index) => (
                                <div className="row border-bottom mb-4" key={index}>
                                    ...
                                    <div className="d-flex justify-content-center align-items-center">
                                        ...
                                        <button onClick={() => UpdateCart(c.product.id, c.product.price, c.product.shipping_amount, c.color, c.size)} className='ms-2 btn btn-primary ms-2'><i className='fas fa-rotate-right'></i></button>
                                    </div>
                            ...
                            {cart.length > 0 &&
                                <div>
                                    ...
                                    <h5 className="mb-1 mt-4">Shipping Detail</h5>
                                    <div className="row mb-4">
                        ...
                        <div className="col-lg-4 mb-4 mb-md-0">
                            ...
                            <section className="shadow-4 p-4 rounded-5 mb-4">
                                ...
                                <button className="btn btn-primary btn-rounded w-100" onClick={createCartOrder}>
