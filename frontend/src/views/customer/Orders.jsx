                                                ...
                                                {orders.map((o, index) => (
                                                    <tr key={index}>
                                                        <td>
                                                            ...
                                                            <p className="text-muted mb-0">{moment(o.date).format('MMM D, YYYY')}</p>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <Link className="btn btn-link btn-sm btn-rounded" to={`/customer/order/${o.oid}/`}>
                                                                View <i className="fas fa-eye" />
                                                            </Link>
                                                            <Link className="btn btn-link btn-sm btn-rounded" to={`/customer/invoice/${o.oid}/`}>
