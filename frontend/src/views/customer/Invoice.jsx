                                ...
                                <div className="col-xs-12 col-sm-12 col-md-12 text-left">
                                    <div className="receipt-right">
                                        <h5 className="margin-top-10">
                                            Long Nguyen Thanh<span className="text-warning">.</span>
                                        </h5>
                                        <p>
                                            <i className="fa fa-phone" /> +84 393589487
                                        </p>
                                        <p>
                                            <i className="fa fa-envelope" /> long@gmail.com
                                        </p>
                                        <p>
                                            <i className="fa fa-location-arrow" /> Ha Noi, Vietnam
                                        </p>
                                    </div>
                                </div>
                            </div>
